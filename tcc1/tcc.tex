...
Em um levantamento realizado pela Microsoft Security Response Center (MSRC) realizado em 2019 \cite{MSRC2019},
...
\par
O primeiro método é o Heap Object Flow Graph (HOFG) \cite{MadhavC2023}, sendo uma representação do fluxo dos blocos de memória alocados na Heap, na qual os vértices do grafo são obtidos 
...
uma integração com o Value-Set Analysis (VSA) \cite{Balakrishnan2007} poderia ser realizada. O VSA, técnica de interpretação abstrata originalmente aplicada para análise de executáveis, 
...
dados pode armazenar em cada ponto de um programa \cite{Balakrishnan2007}. O VSA possui similaridades com o problema de análise de ponteiros (pointer-analysis), frequentemente estudado em análises de 
...
Segundo o Microsoft Security Response Center (MSRC) \cite{MSRC2019}, entre o período de 2004 a 2018 aproximadamente 70\% das vulnerabilidades corrigidas mapeadas a um CVE foram causadas por desenvolvedores 
